...
Insert into ogrenciler values(125,'Kemal can','Istanbul',85);
...
/* -----------------------------------------------------------------------------
 ...
 select isim,sinav_notu from ogrenciler where sinav_notu>80;
...
/* ========================================================================== */
    ...
    INSERT INTO kelimeler VALUES (101, 'hooooooot', 5);
