...
==============================================================================*/
 ...
 where exists(select urun_isim from mart as m
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
 select urun_isim ,musteri_isim from nisan as n
 where not exists(select urun_isim from mart as m
					where n.urun_isim=m.urun_isim);
...
==============================================================================*/
    ...
    -- Ornek 1:isim i null olanlari sorgula
    select * from insanlar where  isim is null;
    
    -- Ornek 1:isim i null olmayanlar sorgula
...
-----------------------------------------------------------------------------*/ 
select * from kisiler where soyisim='Bulut' order by 5;  -- sutuna gore siraladi

-- ********************LIMIT****************************************************
-- listeden 10 veriyi getir
select * from kisiler limit 10;

-- 10. veriden sonraki iki veriyi al
select * from kisiler limit 10,2;  -- ilk sayi dahil degil 11 den basla,2 sayi kadar al
